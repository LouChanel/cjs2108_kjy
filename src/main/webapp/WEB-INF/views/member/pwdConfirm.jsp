	...
	<div class="card align-middle" style="width:22rem; border-radius:20px;">
      ...
      <form name="myform" class="was-validated" method="post">
      	<div class="form-group">
	        ...
	        <input type="text" id="mid" name="mid" class="form-control" placeholder="아이디" required autofocus>
	        <div class="valid-feedback">&nbsp;</div>
					<div class="invalid-feedback">가입된 아이디를 입력해주세요.</div>
				</div>
				<div class="form-group">
	        <label for="toMail" class="sr-only">이메일</label>
	        <input type="text" id="toMail" name="toMail" class="form-control" placeholder="이메일" required>
	        <div class="valid-feedback">&nbsp;</div>
					<div class="invalid-feedback">회원가입시에 등록된 이메일주소를 입력해주세요.</div>
				</div>
        <button id="btn-Login" class="btn btn-lg btn-primary btn-block" type="submit">임시비밀번호 발급</button>
